-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'MANAGER', 'TEAM_MEMBER', 'STAKEHOLDER');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_UPDATED', 'DEADLINE_APPROACHING', 'RISK_ALERT', 'ISSUE_CREATED', 'PROJECT_UPDATE', 'SYSTEM');
